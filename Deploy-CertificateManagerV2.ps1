...
.SYNOPSIS
    Развертывание Менеджера сертификатов V1.0 в целевой папке
.DESCRIPTION
    ...
    Алгоритм развертывания:
        ...
        3. Создание целевой папки C:\CM (или указанной)
    ...
    После развертывания:
        ...
        - В планировщике создаётся задача Update-OnlyCertificates
